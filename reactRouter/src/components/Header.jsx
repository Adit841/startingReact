    ...
    return (
        <header className="shadow sticky z-50 top-0">
            <nav className="bg-white border-gray-200 px-4 lg:px-6">
                <div className="flex flex-wrap justify-between it ">
                    <Link to="/" className="flex items-center" >
                     ...
                     <div className="flex items-center lg:order-2">
                        <link to = "#" className="text-gray-800 hpver:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none ">Log in</link>
